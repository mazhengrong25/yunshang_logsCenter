  ...
  <div class="logs_views">
    ...
    >
      ...
      <el-button
        ...
        type="text"
        @click="closeJsonBtn()"
        >{{ closeJsonType ? "展开全部" : "折叠全部" }}</el-button
      >
      <json-view
        v-if="messageType === 'json'"
        :data="messageType === 'json' ? messageDetails : '{}'"
        :deep="showJsonDeep"
      />
    ...
    <el-dialog title="扩展字段详情" :visible.sync="showFieldDetails" width="400px">
      <el-checkbox-group v-model="fieldDetailsList" class="field_box">
        <div class="field_list">
          ...
          <el-checkbox
            @change="checkedFieldList(fieldDetails.field1, 0)"
            :label="fieldDetails.field1"
          ></el-checkbox>
        </div>
        <div class="field_list">
          ...
          <el-checkbox
            @change="checkedFieldList(fieldDetails.field2, 1)"
            :label="fieldDetails.field2"
          ></el-checkbox>
        </div>
        <div class="field_list">
          ...
          <el-checkbox
            @change="checkedFieldList(fieldDetails.field3, 2)"
            :label="fieldDetails.field3"
          ></el-checkbox>
        </div>
        <div class="field_list">
          ...
          <el-checkbox
            @change="checkedFieldList(fieldDetails.field4, 3)"
            :label="fieldDetails.field4"
          ></el-checkbox>
        </div>
        <div class="field_list">
          ...
          <el-checkbox
            @change="checkedFieldList(fieldDetails.field5, 4)"
            :label="fieldDetails.field5"
          ></el-checkbox>
        </div>
      </el-checkbox-group>
    </el-dialog>
  ...
  methods: {
    ...
    searchBtn() {
      ...
      this.searchForm["endTime"] = this.endTime
        ? this.$getTime(new Date(this.endTime).getTime()).replace(/\s+/g, "T")
        : "";
      this.searchForm["whichPage"] = this.dataPage;
      this.searchForm["pageNums"] = this.dataNum;
      // this.$axios
